...
jQuery(document).ready(function(){
	...
	$('#contactfriend').submit(function(){
		...
		$.post(action, {
			name_footer: $('#name_footer').val(),
			friendname_footer: $('#friendname_footer').val(),
			friendemail_footer: $('#friendemail_footer').val(),
			message_footer: $('#message_footer').val(),
			verify_footer: $('#verify_footer').val()
		},
			function(data){
				document.getElementById('message-friend').innerHTML = data;
				$('#message-friend').slideDown('slow');
				$('#contactfriend img.loader').fadeOut('slow',function(){$(this).remove()});
